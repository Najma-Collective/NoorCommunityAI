...
The Nour AI Tutor now features a powerful **Retrieval Augmented Generation (RAG)** system that enables:
...
This RAG system and all sample lessons are provided under the same license as the Noor AI Tutor project.
...
- **Google Gemini API**: Powers the LLM and embedding generation
- **Najma Collective**: Trauma-informed ELT methodology
...
*Nour - Where AI meets pedagogy, and every learner's journey is unique.*
